...
class TableParser:
    def __init__(self, table_structure_model, device, id2label, ocr_processor, ocr_model):
    ...
    def _apply_ocr(self, table: Image, cell_coordinates):
        ...
        for idx, row in enumerate(tqdm(cell_coordinates)):
            ...
            for cell in row["cells"]:
                ...
                # apply OCR
                pixel_values = self.ocr_processor(cell_image, return_tensors="pt").pixel_values
