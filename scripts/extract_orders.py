...
import torch
from transformers import AutoModelForObjectDetection, TrOCRProcessor, VisionEncoderDecoderModel, AutoTokenizer
...
table_parser = TableParser(structure_model, device, structure_id2label, ocr_processor, ocr_model)
...
for image in images:
    ...
    cropped_tables = table_cropper.crop_detected_tables(image=image, tokens=[], tables=detected_tables)
